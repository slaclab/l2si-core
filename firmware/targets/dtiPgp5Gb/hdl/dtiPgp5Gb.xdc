...
create_generated_clock -name usClk0 [get_pins {GEN_US_PGP[0].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name usClk1 [get_pins {GEN_US_PGP[1].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name usClk2 [get_pins {GEN_US_PGP[2].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name usClk3 [get_pins {GEN_US_PGP[3].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name usClk4 [get_pins {GEN_US_PGP[4].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name usClk5 [get_pins {GEN_US_PGP[5].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name usClk6 [get_pins {GEN_US_PGP[6].U_App/U_Pgp2b/U_BUFG/O}]

set_clock_groups -asynchronous \
                 -group [get_clocks usClk0] \
                 -group [get_clocks usClk1] \
                 -group [get_clocks usClk2] \
                 -group [get_clocks usClk3] \
                 -group [get_clocks usClk4] \
                 -group [get_clocks usClk5] \
                 -group [get_clocks usClk6] \
                 -group [get_clocks -include_generated_clocks amcClk0]

create_generated_clock -name dsClk0 [get_pins {GEN_DS[0].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name dsClk1 [get_pins {GEN_DS[1].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name dsClk2 [get_pins {GEN_DS[2].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name dsClk3 [get_pins {GEN_DS[3].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name dsClk4 [get_pins {GEN_DS[4].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name dsClk5 [get_pins {GEN_DS[5].U_App/U_Pgp2b/U_BUFG/O}]
create_generated_clock -name dsClk6 [get_pins {GEN_DS[6].U_App/U_Pgp2b/U_BUFG/O}]

set_clock_groups -asynchronous \
                 -group [get_clocks dsClk0] \
                 -group [get_clocks dsClk1] \
                 -group [get_clocks dsClk2] \
                 -group [get_clocks dsClk3] \
                 -group [get_clocks dsClk4] \
                 -group [get_clocks dsClk5] \
                 -group [get_clocks dsClk6] \
