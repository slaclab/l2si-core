...
set_property LOC BUFGCE_X1Y0  [get_cells {U_Backplane/U_Clk/U_BUFG}]
...
add_cells_to_pblock [get_pblocks MPS_RTL_GRP] [get_cells -quiet [list U_Backplane/U_SaltUltraScale]]
