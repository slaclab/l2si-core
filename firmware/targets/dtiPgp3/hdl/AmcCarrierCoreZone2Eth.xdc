...
#create_generated_clock -name ethPhyClk    [get_pins -hier -filter {name =~ U_Core/U_Eth/ETH_ZONE2.U_Xaui/XauiGthUltraScale_Inst/*/gthe3_channel_gen.gen_gthe3_channel_inst[0].GTHE3_CHANNEL_PRIM_INST/TXOUTCLK}]
create_generated_clock -name ethPhyClk [get_pins -hier -filter {name =~ U_Core/U_Eth/U_Eth/XauiGthUltraScale_Inst/*/gthe3_channel_gen.gen_gthe3_channel_inst[0].GTHE3_CHANNEL_PRIM_INST/TXOUTCLK}]
