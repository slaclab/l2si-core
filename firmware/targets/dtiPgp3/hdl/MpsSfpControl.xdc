...
#set_property -dict {PACKAGE_PIN AN8  IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrScl[0][0]}]
#set_property -dict {PACKAGE_PIN AK10 IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrScl[0][1]}]
#set_property -dict {PACKAGE_PIN AN9  IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrScl[0][2]}]
#set_property -dict {PACKAGE_PIN AP8  IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrSda[0][0]}]
#set_property -dict {PACKAGE_PIN AL9  IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrSda[0][1]}]
#set_property -dict {PACKAGE_PIN AJ8  IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrSda[0][2]}]
...
#set_property -dict {PACKAGE_PIN AD9  IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrScl[1][0]}]
#set_property -dict {PACKAGE_PIN AD10 IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrScl[1][1]}]
#set_property -dict {PACKAGE_PIN AE8  IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrScl[1][2]}]
#set_property -dict {PACKAGE_PIN AD8  IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrSda[1][0]}]
#set_property -dict {PACKAGE_PIN AE10 IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrSda[1][1]}]
#set_property -dict {PACKAGE_PIN AH8  IOSTANDARD LVCMOS25 DRIVE 8} [get_ports {hsrSda[1][2]}]
