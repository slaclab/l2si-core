...
set_property IOSTANDARD DIFF_HSTL_I [get_ports ddrClkN]
set_property IOSTANDARD DIFF_HSTL_I [get_ports ddrClkP]
set_property IBUF_LOW_PWR FALSE [get_ports ddrClkN]
set_property IBUF_LOW_PWR FALSE [get_ports ddrClkP]
set_property KEEPER true [get_ports ddrClkN]
set_property KEEPER true [get_ports ddrClkP]
