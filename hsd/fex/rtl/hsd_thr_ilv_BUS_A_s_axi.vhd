...
entity hsd_thr_ilv_BUS_A_s_axi is
generic (
...
end entity hsd_thr_ilv_BUS_A_s_axi;
...
-- 0x08 : reserved
-- 0x0c : reserved
-- 0x10 : Data signal of config_a
--        bit 31~0 - config_a[31:0] (Read/Write)
-- 0x14 : reserved
...
architecture behave of hsd_thr_ilv_BUS_A_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_CONFIG_A_DATA_0 : INTEGER := 16#10#;
    ...
    -- internal registers
    signal int_config_a        : UNSIGNED(31 downto 0) := (others => '0');
    signal int_config_b        : UNSIGNED(31 downto 0) := (others => '0');
    signal int_config_c        : UNSIGNED(31 downto 0) := (others => '0');
    signal int_config_d        : UNSIGNED(31 downto 0) := (others => '0');
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CONFIG_A_DATA_0) then
                    int_config_a(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_config_a(31 downto 0));
                end if;
            end if;
        end if;
    end process;
